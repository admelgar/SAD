...
<form class="form-horizontal" role="form">
  <div class="form-group">
    <label class="control-label col-sm-5" for="class">Classification </label>
    <div class="col-sm-6">
  ...
  <div class="form-group">
    <label class="control-label col-sm-5" for="rep">Name of Representative </label>
    <div class="col-sm-3">
  ...
  <div class="form-group">
    <label class="control-label col-sm-5" for="co">Name of Co-maker </label>
    <div class="col-sm-3">
      <input type="text" class="form-control form-control-inline2" id="last" placeholder="Enter last name">
    </div>
    <div class="col-sm-3">
  ...
  <div class="form-group">
    <label class="control-label col-sm-5" for="tel">Telephone Number </label>
    <div class="col-sm-6">
  ...
  <div class="form-group">
    <label class="control-label col-sm-5" for="oadd">Office Address </label>
    <div class="col-sm-6"> 
  ...
  <div class="form-group">
    <label class="control-label col-sm-5" for="notes">Notes </label>
    <div class="col-sm-6">
