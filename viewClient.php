...
?> 
	...
	<div class="table-responsive" id="view_all_table">
        ...
        <?php
            ...
            $sql = "SELECT clients.client_id, cases.case_id, clients.representative_last_name, clients.representative_first_name, cases.date_of_release, cases.date_of_maturity, cases.loan_amount, cases.actual_total_balance, cases.status FROM clients, cases WHERE clients.client_id=cases.client_id;";
