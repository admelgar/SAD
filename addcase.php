...
<form class="form-horizontal" role="form">
  <div class="form-group">
    <label class="control-label col-sm-5" for="loan">Loan Amount </label>
    <div class="col-sm-4">
      <input type="number" class="form-control" id="loan" placeholder="Enter amount">
    </div>
  </div>
  <div class="form-group">
    <label class="control-label col-sm-5" for="release">Date of Release </label>
    <div class="col-sm-4">
  ...
  <div class="form-group">
    <label class="control-label col-sm-5" for="rate">Weekly Interest Rate </label>
    <div class="col-sm-3">
